...
export function ThemeSwitcher() {
  ...
  if(!mounted) {
    return <>
      <Button className='dark:hidden bg-inherit' variant='solid' size='lg' disableRipple disableAnimation isIconOnly><MdOutlineDarkMode /></Button>
      <Button className='hidden dark:flex bg-inherit ml-2' variant='solid' size='lg' disableRipple disableAnimation isIconOnly><MdOutlineLightMode /></Button>
    </>
  }
